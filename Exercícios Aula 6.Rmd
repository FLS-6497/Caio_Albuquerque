...
gr_bow3 <- po("textvectorizer", param_vals = list(stopwords_language = "pt"), remove_punct = TRUE, remove_numbers = TRUE, remove_symbols = TRUE, min_termfreq = 20, n = 2) %>>%
...
design <- benchmark_grid(
  tasks = tsk,
  learners = list(gr_bow1, gr_bow2, gr_bow3),
  resampling = rsmp("holdout", ratio = 0.7)
)
